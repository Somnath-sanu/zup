...
/**
 * form.handleSubmit(onSubmit) returns a function that expects an event (like form submit or key press).
 * 
 * form.handleSubmit(onSubmit)(e); -> equivalent -> 
 * const handle = form.handleSubmit(onSubmit);
  handle(e); // e is the event
*/
